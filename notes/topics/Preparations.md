BFS , Toplogical Sort, Heap
Range Sum Query- Segment Tree
dynamic programming 
trees, graphs, greedy algorithms, and DP 
...
important topics like Tree, BST, Graph, Shortest Path, Trie, BFS, Disjoint Set, Matrix, etc.
...
Graph problem involving a modified DFS approach. 
...
Binary Search Tree
DP & Memo
Binary Search (especially where binary search is not obvious)
Graph(DFS, BFS, Topological sort, Dijkstra’s etc.)
...
Top Google Questions- https://leetcode.com/problem-list/7p55wqm/
...
sorting, greedy, map.
priority queue, sorting and greedy
simple bfs
